...
namespace WpfControlX.ExtendedDefinitions
{
    public class ImageButton : Button
    {
        ...
        public ImageButton()
        {
            this.SetCurrentValue(ImageButton.ImageLocationProperty, ExtendedDefinitions.ImageLocation.Left);
        }
